...
data=data
exp=exp
exp_name=vox12_resnet293
data_type=shard
num_avg=10
gpus=[0,1,2,3,4,5,6,7]
checkpoint=
config=/VAF/train/egs/voxceleb/sv-resnet/conf/resnet293_wenet.yaml
config=/VAF/train/egs/voxceleb/sv-resnet/conf/resnet293_wenet_lm.yaml
