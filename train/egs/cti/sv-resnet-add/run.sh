...
data=data
exp=exp
exp_name=cjsd8000_resnet101_wav2vec2
data_type=raw #shard
num_avg=10
gpus=[0,1,2,3]
checkpoint=
config=/VAF/train/egs/cti/sv-resnet-add/conf/resnet101_wenet.yaml
lm_config=/VAF/train/egs/cti/sv-resnet-add/conf/resnet101_wenet_lm.yaml
