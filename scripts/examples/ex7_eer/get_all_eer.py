...
if __name__ == "__main__":
    ...
    # computer EER
    os.makedirs(f"./output_pngs/{cfg.NAME}",exist_ok=True)
    result = metrics.compute_eer(scores, labels,det_pic_save_path=f"./output_pngs/{cfg.NAME}/{cfg.NAME}_det.png",roc_pic_save_path=f"./output_pngs/{cfg.NAME}/{cfg.NAME}_roc.png")
    ...
    # write to file
    with open(f"./output_pngs/{cfg.NAME}/{cfg.NAME}_precision_recall.txt","w") as f:
