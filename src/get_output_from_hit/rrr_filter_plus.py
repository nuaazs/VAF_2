...
def check_text(text):
    ...
    if a_count > 0:
        return None,f"LOOKAHEAD_WHITE:{a_text}"
    ...
    for key in BLACK_3.keys():
        ...
        if a_count > 0 and b_count > 0 and c_count > 0:
            ...
            return key_text,f"BLACK_3:{a_text},{b_text},{c_text}"
    ...
    for key in BLACK_2.keys():
        ...
        if (a_count > 0 and b_count > 0) and (a_count + b_count >= num_th):
            ...
            return key_text,f"BLACK_2:{all_keys_text}"
