...
class get_embedding:
    def __init__(self,
        ...
        self.device = torch.device(cfg.ENCODE_CAMPP_DEVICE)
        self.n_mels = n_mels
        self.sample_rate = sample_rate
        ...
        self.model.load_state_dict(torch.load(os.path.join(checkpoints_dir,'embedding_model.ckpt'),map_location=self.device))
...
emb = get_embedding(n_mels = 80,embedding_size = 192,sample_rate = 16000,epoch = 80,
        checkpoints_dir = f"models/CAMPP_200k_F3dspeaker")
# import cfg
# emb = emb.to(cfg.ENCODE_CAMP_DEVICE)
