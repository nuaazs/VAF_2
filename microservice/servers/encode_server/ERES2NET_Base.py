...
emb = SpeakerVerificationERes2Net(model_dir=f"models/ERES2NET_BASE",model_config=config,pretrained_model=config['model']['pretrained_model'])
# import cfg
